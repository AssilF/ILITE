...
// ============================================================================
// Bulky Module Class (ILITE Framework Integration)
// ============================================================================
...
public:
    ...
    PacketDescriptor getCommandPacketDescriptor(size_t index) const override {
        if (index == 0) {
            return {
                ...
                sizeof(BulkyCommand),
                sizeof(BulkyCommand),
                false,  // No magic number in command
                nullptr,
                0
            };
        }
    ...
    PacketDescriptor getTelemetryPacketDescriptor(size_t index) const override {
        if (index == 0) {
            return {
                "Bulky Telemetry",
                BULKY_PACKET_MAGIC,
                sizeof(BulkyTelemetry),
                sizeof(BulkyTelemetry),
                true,  // Validate magic number
                nullptr,
                0
            };
        }
    ...
    void drawLayoutCard(DisplayCanvas& canvas, int16_t x, int16_t y, bool focused) override {
        drawBulkyLayoutCard(x, y, focused);
    }
};
